...
<head>
  ...
  <title>Admin Sistem Merek</title>
...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <symbol id="file-earmark-post" viewBox="0 0 16 16">
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white bg-dark shadow-none">Admin Sistem Merek</a>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="sidebarMenuLabel">HKI Admin Panel</h5>
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/admin/verifikasi">
                  <svg class="bi">
                    <use xlink:href="#person-add"></use>
                  </svg>
                  Verifikasi Pengguna
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/admin/permohonan">
                  <svg class="bi">
                    <use xlink:href="#file-earmark-post"></use>
                  </svg>
                  Permohonan Merek
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/admin/pemohon">
                  <svg class="bi">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/admin/pengumuman">
                  <svg class="bi">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/admin/infografis">
                  <svg class="bi">
            ...
            <ul class="nav flex-column mb-auto">
              ...
              <li class="nav-item d-flex align-items-center justify-content-center">
                <form class="inline" action="/admin/logout" method="POST">
                  @csrf
      ...
      <main class="mt-2 col-md-9 ms-sm-auto col-lg-10 px-md-4">